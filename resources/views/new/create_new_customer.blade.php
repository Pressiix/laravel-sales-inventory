...
@section('content')
      <div class="col-15 bg-fff">
        <div class="content-inventory">
          ...
          {!! Form::open(['action' => ['CustomerController@storeCustomer', 'method' => 'POST'],'onsubmit'=>'return confirm(\'Are you sure you wish to create customer?\')']) !!}
            ...
            <div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-12">
                  <input type="text" name="customer_nickname" class="form-control">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">Tel no:</label>
                <div class="col-sm-12">
                  <input type="text" name="customer_telephone" class="form-control">
                </div>
              </div>
              <div class="form-group row">
